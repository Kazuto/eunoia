...
<table>
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>
        Mode-agnostic classes (no <code>dark:</code> prefix, no light-only
        semantics)
      </td>
      <td>
        <code>flex</code>, <code>rounded-lg</code>, <code>px-4</code>,{" "}
        <code>font-sans</code>
      </td>
    </tr>
    <tr>
      <td>2</td>
      <td>Light-only classes (colors/borders that only apply in light mode)</td>
      <td>
        <code>bg-white</code>, <code>text-neutral-900</code>,{" "}
        <code>border-neutral-200</code>
      </td>
    </tr>
    <tr>
      <td>3</td>
      <td>
        All <code>dark:</code> prefixed classes
      </td>
      <td>
        <code>dark:bg-neutral-900</code>, <code>dark:text-neutral-100</code>
      </td>
    </tr>
  </tbody>
</table>
