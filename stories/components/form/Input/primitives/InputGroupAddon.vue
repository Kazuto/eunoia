...
const variants = tv({
  ...
  variants: {
    role: {
      button: [
        "cursor-pointer outline-none focus:text-primary-300 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 dark:focus:text-primary-500",
      ],
    },
  },
  compoundVariants: [
